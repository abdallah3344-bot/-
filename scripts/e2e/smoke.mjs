...
const MODULE_ROUTES = (process.env.E2E_ROUTES ?? '/dashboard,/clients,/cases,/hearings,/calendar,/tasks,/documents,/powers-of-attorney,/contracts,/archive,/users,/profile').split(',').filter(Boolean)
